...
try:
    ...
    print('No sparse_gym_mujoco Gym. Skipping...')
...
class Actor(RLNN):
    ...
    def mmdupdate(self,memory,batch_size,actor_best,critic, actor_t,n=None):
        ...
        states, _, _, _, _ = memory.sample(batch_size)
        actor_loss = -critic(states, self(states))[0].mean()-self.mmdloss*mmd_loss
...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', default='Ant-v2', type=str)#HalfCheetah
    parser.add_argument('--seed', default=1, type=int)
    parser.add_argument('--mmdloss', default=0.1, type=float)
